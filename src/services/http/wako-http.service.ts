...
export class WakoHttpService {
  ...
  static async capacitorMobileRequest(httpRequest: WakoHttpRequest): Promise<WakoHttpResponse> {
    try {
      const response: HttpResponse = await CapacitorHttp.request({
        method: httpRequest.method,
        url: httpRequest.url,
        headers: httpRequest.headers as HttpHeaders,
        data: httpRequest.body === null ? undefined : httpRequest.body,
  ...
  /**
   *
   * @deprecated use capacitorMobileRequest instead
   * @param httpRequest
   * @returns
   */
  static cordovaMobileRequest(httpRequest: WakoHttpRequest): Promise<WakoHttpResponse> {
  ...
  static mobileRequest(httpRequest: WakoHttpRequest): Observable<WakoHttpResponse> {
    return from(
